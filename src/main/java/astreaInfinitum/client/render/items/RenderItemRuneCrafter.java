...
public class RenderItemRuneCrafter implements IItemRenderer {
	...
	private void renderToInventory(ItemStack item, RenderBlocks renderBlocks) {
		...
		Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation(ModProps.modid + ":textures/models/CarvingTable.png"));
		CarvingTable carv= new CarvingTable();
		carv.render(0.0625f);
