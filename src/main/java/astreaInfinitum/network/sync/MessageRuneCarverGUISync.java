...
public class MessageRuneCarverGUISync implements IMessage, IMessageHandler<MessageRuneCarverGUISync, IMessage> {
	...
	public MessageRuneCarverGUISync() {
	 ...
	 * @param z
	 */
	public MessageRuneCarverGUISync(List<CoordinatePair> nodes, List<MutablePair<CoordinatePair, CoordinatePair>> lines, CoordinatePair prevNode, int x, int y, int z) {
		this.nodes = nodes;
		this.lines = lines;
	...
	public MessageRuneCarverGUISync(TileEntityRuneCarver tile) {
	...
	@Override
	public IMessage onMessage(MessageRuneCarverGUISync message, MessageContext ctx) {
